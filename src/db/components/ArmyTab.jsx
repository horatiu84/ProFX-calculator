                  ...
                  <table className="w-full">
                    ...
                    <tbody>
                      {currentRows.map((row, index) => (
                        <tr 
                          key={row.key}
                          className={`border-b border-gray-800 hover:bg-gray-800/50 transition-colors ${row.representative.textOnly ? 'cursor-default' : 'cursor-pointer'}`}
                          onClick={() => !row.representative.textOnly && setSelectedScreenshot(row.representative)}
                        >
                          <td className="py-3 px-4 text-blue-400 font-semibold">{startIndex + index + 1}</td>
                          <td className="py-3 px-4 text-white">
                            <div className="flex items-center gap-2">
                              {row.representative.textOnly ? (
                              ...
                              <span className={`truncate ${row.representative.textOnly ? 'text-blue-300 italic' : ''}`}>
