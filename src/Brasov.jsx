        ...
        <div className="mt-8 md:mt-12 text-center">
          <div className="inline-flex flex-col md:flex-row items-center gap-3 md:gap-6 text-gray-400 text-sm md:text-base">
            <div className="flex items-center gap-2">
              ...
              <span>{language === "ro" ? "Program: 09:00 - 18:00" : "Schedule: 09:00 AM - 06:00 PM"}</span>
            </div>
            ...
            <div className="flex items-center gap-2">
              ...
              <span>{language === "ro" ? "Networking & Cafea" : "Networking & Coffee"}</span>
            </div>
            <span className="hidden md:inline">•</span>
            <div className="flex items-center gap-2">
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <span>{language === "ro" ? "Certificat de Participare" : "Certificate of Participation"}</span>
            </div>
          </div>
        </div>
